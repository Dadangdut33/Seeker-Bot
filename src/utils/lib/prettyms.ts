...
// Original: https://github.com/sindresorhus/parse-ms
...
// Original: https://github.com/sindresorhus/pretty-ms
export function prettyMilliseconds(milliseconds, options = {}) {
